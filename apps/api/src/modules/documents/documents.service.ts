...
export class DocumentsService {
  ...
  async get(id: string) {
    ...
    const result = (await this.prisma.$runCommandRaw({ find: this.collection, filter: { _id: id } as JsonObject, limit: 1, projection: { storagePath: 0 } })) as unknown as MongoFindResult<DocumentRecord>;
