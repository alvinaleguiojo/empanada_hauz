    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3 border-b border-line/70 pb-3">
        ...
        <div className="inline-flex shrink-0 rounded-lg border-2 border-line bg-panel p-1 shadow-sm" role="group" aria-label="Order view">
          <Button type="button" variant="ghost" aria-pressed={view === "kanban"} onClick={() => setView("kanban")} className={cn("h-9 gap-2 px-4 font-semibold", view === "kanban" && "bg-accent text-white hover:bg-accent/90")}>
            <LayoutGrid size={16} />
            Kanban
          </Button>
      ...
      {view === "kanban" ? (
        <div className="orders-board-root">
