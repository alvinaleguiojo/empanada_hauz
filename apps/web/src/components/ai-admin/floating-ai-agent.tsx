...
export function FloatingAiAgent() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-5 right-24 z-[10000] sm:right-28">
      <div className="pointer-events-auto flex flex-col items-end gap-3">
        {open ? (
          <div className="flex h-[min(620px,calc(100dvh-110px))] w-[min(420px,calc(100vw-24px))] flex-col overflow-hidden rounded-2xl border border-accent/20 bg-background shadow-[0_28px_90px_rgba(0,0,0,0.5)] ring-1 ring-white/[0.04]">
