...
export function TrackingRiderMap({ orderId, initialJob = null }: Props) {
  ...
  const hasFreshLocation = isFresh(job?.rider?.location);

  return (
    <section className="rounded-[22px] border border-line/80 bg-panel p-4 sm:p-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-[0.18em] text-foreground/35">Live Delivery Tracking</p>
          <h2 className="mt-2 text-xl font-semibold">Track your rider</h2>
