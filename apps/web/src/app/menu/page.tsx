    ...
    <main className="min-h-screen bg-[#1C2941] px-5 py-12 text-[#F2E8D5]">
      <article className="mx-auto max-w-4xl">
        ...
        <p className="mt-5 max-w-3xl text-lg text-[#F2E8D5]/80">
          Choose from the available Empanada Hauz flavors, then build your box online.
        </p>
        <div className="mt-10 grid gap-4 sm:grid-cols-2">
          {flavors.map(([name, slug]) => (
            <Link
              ...
              className="rounded-2xl border border-[#F2E8D5]/10 bg-[#241c13]/70 p-5 hover:border-[#E3A64B]/50"
            >
        ...
        <Link
          className="mt-10 inline-flex rounded-full bg-[#C0472B] px-6 py-3 font-bold text-white"
          href="/order"
        >
          Build Your Box
        </Link>
