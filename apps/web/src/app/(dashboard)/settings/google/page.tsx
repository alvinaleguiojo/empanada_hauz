...
type GoogleOAuthStart = { url: string };
...
export default function GoogleWorkspaceSettingsPage() {
  ...
  async function connect() {
    ...
    try {
      const result = await apiFetch<GoogleOAuthStart>("/google-workspace/oauth/start");
      window.location.assign(result.url);
    } catch (e) {
      setError(e instanceof Error ? e.message : "Unable to start Google OAuth.");
      setBusy(false);
    }
  }
