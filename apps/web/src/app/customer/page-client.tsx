...
export default function CustomerKioskPage() {
  ...
  const summary = useMemo(() => {
    ...
    return { items, totalQuantity, subtotal, deliveryFee, total: subtotal + deliveryFee };  }, [selectedFlavors, deliveryQuote, form.deliveryMethod]);
        ...
        <header className="sticky top-0 z-40 -mx-3 border-b border-line/10 bg-background/95 px-3 py-3 backdrop-blur-xl sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-3">
            <div className="flex min-w-0 items-center gap-3">
              <div className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-accent text-foreground shadow-[0_8px_24px_-14px_rgb(var(--accent) / 0.9)]"><ChefHat size={20} /></div>              <div className="min-w-0">
