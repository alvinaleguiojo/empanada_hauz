...
export default function RiderMapView({ riderLocation, status, pickup, dropoff, pickupAddress, dropoffAddress, onClose }: Props) {
  ...
  return <View style={s.container}>
    ...
    <View style={s.header}><Pressable accessibilityLabel="Go back" onPress={onClose} style={s.back}><Text style={s.backText}>‹</Text></Pressable><Image source={require("../web/public/empanada hauz logo.jpg")} style={s.logo} resizeMode="contain" /><View style={s.online}><View style={s.green} /><Text style={s.onlineText}>Online</Text></View></View>
